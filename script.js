...
function caracterEn(str, indice)
...
{ return arr.length ? sumaArray(arr) / arr.length : 0; }
...
function contarElemento(arr, el)
...
function actualizarEdad(obj, edad)
 { obj.edad = edad; return obj; }
...
console.log('elimiabrenarPropiedad:', eliminarPropiedad({ a: 1, b: 2 }, 'a')); // { b: 2 }
